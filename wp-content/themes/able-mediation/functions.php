...
function load_scripts() {
	...
	// main js didnt work, fucks sake: wp_enqueue_script('able-js', get_stylesheet_directory_uri(). '/js/able.js', array('jquery', 'jquery-ui', 'jquery-cookie' ), '1.0', true);
...
// 2./ specific pages		
	...
	if (is_page_template('page-templates/home-page.php')  || is_page_template('page-templates/home-page-slider.php')){
		wp_enqueue_script('quote-author-home', get_stylesheet_directory_uri(). '/js/quote-author-home.js#asyncload', array('jquery'), '1.0' );
		// image slider
		...
		wp_enqueue_script('flex-control', get_stylesheet_directory_uri(). '/js/flex-control.js#asyncload', array('jquery','flexslider'), '1.0', true);
	}
...
function mytheme_dequeue_stuff() {
	wp_dequeue_style( 'twentytwelve-fonts' );
	wp_dequeue_style( 'twentytwelve-ie' );
	}	 
add_action( 'wp_enqueue_scripts', 'mytheme_dequeue_stuff', 2 );
