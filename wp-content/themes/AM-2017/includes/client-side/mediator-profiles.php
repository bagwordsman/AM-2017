<?php
// mediator profiles
// - save info added in Users > Your Profile
// - output info with a shortcode


// remove unwanted fields from user admin panel
...
<div class="profile-image">
	...
	<table class="form-table">
		...
		<!-- hidden text fields to capture img width and height -->
		<!-- width -->
		<tr class="invisible">
			<td></td>
			<td>
...
jQuery(document).ready(function() {
	...
	(function($){
		...
		$(document).find("input[id^='uploadimage']").live('click', function(){
			...
			// include img size
			mediatorImgWidth = $('img',html).width();
			mediatorImgHeight = $('img',html).height();
			$('#imageWidth').val(mediatorImgWidth);
			$('#imageHeight').val(mediatorImgHeight);
...
// add thickbox (media upload) if user is logged in
