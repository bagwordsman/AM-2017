...
<div id="content" role="main">
	...
	<span class="divider grey"></span>
			...
			echo '<div class="greywrapper">';
					...
					// column 1
					echo ( $c1 ? ('<div class="four columns stage">' . $c1 . ( $c1_buttontext ? ('<div class="button--container"><a class="button blue" href="'. $c1_buttonlink .'">' . $c1_buttontext . '</a></div>')  : '') .'</div>')  : '');

					// column 2
					echo ( $c2 ? ('<div class="four columns stage">' . $c2 . ( $c2_buttontext ? ('<div class="button--container"><a class="button blue" href="'. $c2_buttonlink .'">' . $c2_buttontext . '</a></div>')  : '') .'<div class="columns--divider"></div></div>')  : '');

					// column 3
					echo ( $c3 ? ('<div class="four columns stage">' . $c3 . ( $c3_buttontext ? ('<div class="button--container"><a class="button blue" href="'. $c3_buttonlink .'">' . $c3_buttontext . '</a></div>')  : '') .'<div class="columns--divider"></div></div>')  : '');
